...
- Natasa Jovanovic: Implementing and experimenting with DDQN and EWC for Atari games, refactoring the code for running the 2A and 2B experiments, running 2B experiments for permutated and rotated MNIST, writing report
